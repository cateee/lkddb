...
class pnp_card(list_of_structs_scanner):
    ...
    def store(self, dict):
        ...
        dict_prod = parse_struct(pnp_card_intern_scanner, unwind_array, line, None, None, ret=True)
...
class pcmcia(list_of_structs_scanner):
    ...
    def store(self, dict):
        ...
        if match & (self.PCMCIA_DEV_ID_MATCH_PROD_ID1 | self.PCMCIA_DEV_ID_MATCH_PROD_ID2 |
            ...
            prods = dict["prod_id"]
            line = split_structs(prods)[0]
            dict_prod = parse_struct(pcmcia_intern_scanner, unwind_array, line, None, None, ret=True)
...
class input(list_of_structs_scanner):
    ...
    def store(self, dict):
        ...
        if match & self.INPUT_DEVICE_ID_MATCH_VERSION:
            v3 = extract_value("version", dict)
        v4, v5, v6, v7, v8 = -1, -1, -1, -1, -1
        v9, v10, v11, v12 = -1, -1, -1, -1
