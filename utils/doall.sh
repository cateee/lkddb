...
do_tar_kernel() {
    ...
    build-lkddb "$kdir/linux-$1"
}


do_tar_kernel 'v2.6.0'
do_tar_kernel 'v2.6.1'
do_tar_kernel 'v2.6.2'
do_tar_kernel 'v2.6.3'
do_tar_kernel 'v2.6.4'
do_tar_kernel 'v2.6.5'
do_tar_kernel 'v2.6.6'
do_tar_kernel 'v2.6.7'
do_tar_kernel 'v2.6.8'
do_tar_kernel 'v2.6.9'
do_tar_kernel 'v2.6.10'
do_tar_kernel 'v2.6.11'
